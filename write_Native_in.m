function write_Native_in(mat, ord, ri_iv, h_iv, P_iv, Q_iv, output_flags, params)
...
%     %Uniform infl
    Ki_Tact = params.Ki_Tact;
    phi_Tact0_min = params.phi_Tact0_min;
    gamma_i = params.gamma_i;
    Ki_steady = params.Ki_steady; %0.80;
    delta_i = params.delta_i;
    K_infl_eff = params.K_infl_eff;
    s_int_infl = params.s_int_infl;

    delta_m = params.delta_m;
    K_mech_eff = params.K_mech_eff;
    s_int_mech = params.s_int_mech;

    epsilonR_e_min = params.epsilonR_e_min;
