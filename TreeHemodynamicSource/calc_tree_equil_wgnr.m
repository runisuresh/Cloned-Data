function order_geom_actual = calc_tree_equil_wgnr(order_geom, mat_tree, mat_temp, n_orders, hemo, gamma_p_ord, gamma_q_ord, gamma_act_ord, cmd_flags, output_flags)
...
%applied to mat_temp for each vessel order.
    ...
    for ord = n_orders: -1: 1
        ...
        write_Native_in(mat_temp, ord, ri_iv, h_iv, P_iv, Q_iv, output_flags);
